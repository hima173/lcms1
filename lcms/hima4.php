  ...
  <div class="row">
    ...
    <div class="column">
      <form action="/action_page.php">
        <br><label for="fname">First Name : Sidharth Luthra</label></br>
		<br><label for="Education">Education  : LLB and LLM</label></br>
		<br><label for="Address">Address : Krishna Complex , Ahmedabad, Gujarat</label></br>
		...
		<br><label for="Appointment">Appointment : www.sidharthindia.com</label></br>
        <br><label for="phone no">Phone no : 9854763210</label></br>
        <br><label for="Experience"> Experience :19 years experienced in the law field </label></br>
