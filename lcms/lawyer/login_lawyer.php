...
<body style="background-image: url('images/1.jpg');">
  ...
  <div class="col-md-5">
    <div class="card card-login mx-auto mt-5">
      <div class="card-header text-white" style="background:#eac15a;">Login Lawyer</div>
      <div class="card-body">
	  <?php 
	if(isset($_GET['login_error']) && $_GET['login_error']==2){
		echo "<p class='error'>Your request is rejected by Admin!!!!</p>";
	}
	if(isset($_GET['login_error']) && $_GET['login_error']==1){
		echo "<p class='error'>Invalid Email & Password!!!!</p>";
	}
	if(isset($_GET['login_error']) && $_GET['login_error']==3){
		echo "<p class='error'>Your request is pending!!!!</p>";
	}
?>
...
<!-- <p class="mt-2 text-secondary">Or</p> -->
        <div class="text-center">
          <a class="d-block small mt-3" href="signup_lawyer.php">Register an Account</a>
