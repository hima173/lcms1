...
<br>
  ...
  <div class="col-md-6">
    ...
    <label for="Qualification" class="ftclr">Qualification</label>
              
              <select name="Qualification" id="Qualification">
                <option value="Male">LLB</option>
                <option value="Female">LLM</option>
                <option value="Other">Both LLB and LLM</option>
              </select>
            </div>
            
            <p>Click on the "Choose File" button to upload a Degree certificates:</p>
    ...
    <div class="form-group">
      ...
      <div class="form-group">
          <label for="State" class="ftclr">City</label>
  ...
  <div id="wrap">
   ...
   <select class="security" name="security1">
      ...
      <option value="3">What is your mother's favorite color?</option>
   ...
   <select class="security" name="security2">
      ...
      <option value="3">Pink</option>
          ...
          <button type="submit" class="btn btn-primary mt-2 " id="reg">Register</button>
        </form>
		<p class="mt-2 ftclr">Or</p>
        
          <a class="d-block small mb-2" href="login_lawyer.php">Login Page</a>
