...
if(isset($_POST['email_verification'])){
  ...
  $emp_verify = mysqli_real_escape_string($conn,$_POST['email']);
  echo $query = "SELECT decipher_lawyer_login_user.email , decipher_lawyer_login_lawyer.email FROM decipher_lawyer_login_user, decipher_lawyer_login_lawyer where decipher_lawyer_login_lawyer.email = decipher_lawyer_login_user.email and  decipher_lawyer_login_lawyer.email = '$emp_verify'";
