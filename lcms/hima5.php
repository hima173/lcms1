  ...
  <div class="row">
    ...
    <div class="column">
      <form action="/action_page.php">
        <br><label for="fname">First Name : Ram Jethmulani</label></br>
		<br><label for="Education">Education  : LLB and LLM</label></br>
		<br><label for="Address">Address : Krishna Complex , Rajkot, Gujarat</label></br>
		...
		<br><label for="Appointment">Appointment : www.ramindia.com</label></br>
